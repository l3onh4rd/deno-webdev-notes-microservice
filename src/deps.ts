...
export * as benchmark from "https://deno.land/std@0.154.0/testing/bench.ts";
export { v4 } from "https://deno.land/std@0.154.0/uuid/mod.ts";
export * as t from "https://deno.land/std@0.154.0/testing/asserts.ts";
