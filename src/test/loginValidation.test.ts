...
Deno.test("test passwordValidation utils function, should return false for invalid password (too long)", (): void => {
    const expected = false;
    const actual :boolean = validatePassword("Username123456789Username12345!\"§%&/(6789Username123456789Userna123456");
    t.assertEquals(actual, expected);
});

Deno.test("test passwordValidation utils function, should return true for valid password (exactly 64 characters)", (): void => {
    const expected = true;
    const actual :boolean = validatePassword("Username123456789Username12345!\"§%&/(6789Username123456789Userna");
    t.assertEquals(actual, expected);
});
