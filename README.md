...
Use the .postman_collection.json files from the root
...
Api. These request are only for local use. Your JWT token is valid for 60
minutes. There are 4 collections.
